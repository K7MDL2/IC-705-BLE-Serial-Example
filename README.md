...
Recent fixes (April 2026) improve using the M5Stack USB port as a CAT serial port (aka PC Passthru Mode - on by default). I also improved the touch button detection on the Core2.  Visit the Issues page to track what is on the radar.
